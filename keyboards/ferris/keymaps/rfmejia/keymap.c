...
/* const uint16_t PROGMEM combo_lt[]   = {HM_S, KC_C, COMBO_END}; */
/* const uint16_t PROGMEM combo_gt[]   = {HM_T, LT_D, COMBO_END}; */

/* const uint16_t PROGMEM combo_tab[]  = {KC_COLN, HM_O, COMBO_END}; */
/* const uint16_t PROGMEM combo_mins[] = {KC_L, HM_N, COMBO_END}; */
/* const uint16_t PROGMEM combo_eql[]  = {KC_U, HM_E, COMBO_END}; */
/* const uint16_t PROGMEM combo_lbrc[] = {HM_N, LT_H, COMBO_END}; */
/* const uint16_t PROGMEM combo_rbrc[] = {HM_E, KC_COMM, COMBO_END}; */
