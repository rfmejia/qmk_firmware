...
[_SYM] = LAYOUT(
KC_LCBR, KC_RCBR, KC_DQUO, KC_QUOT, M_LARR,  XXXXXXX, XXXXXXX, M_RARR,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC,
KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, XXXXXXX, XXXXXXX, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
M_BOX,   XXXXXXX, KC_GRV,  KC_TILD, KC_BSLS, XXXXXXX, XXXXXXX, KC_PIPE, KC_UNDS, KC_PLUS, KC_LT,   KC_GT,
XXXXXXX, XXXXXXX, XXXXXXX, TO_DEF,  _______,     XXXXXXX,      _______, TO_DEF,  XXXXXXX, XXXXXXX, XXXXXXX
),
